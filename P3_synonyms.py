...
# clusters_tweets_text = []  # list of list of tweets, one sublist per cluster
...
## Writing data
write_data('./incentive_clean.csv', tweetsProcessed)
write_data('./incentive_altered.csv', tweetsAltered)
write_data('./incentive_clean_stem.csv', tweetsProcessed_stem)
write_data('./incentive_altered_stem.csv', tweetsAltered_stem)
print('data saved')